...
<div class="container-fluid">
	...
	<span class="caret"></span></button>
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          <li ><a role="menuitem" tabindex="-1" href="../Role/batsman_uncapped.php">Batsman</a></li>
          <li ><a role="menuitem" tabindex="-1" href="../Role/bowler_uncapped.php">Bowler</a></li>
          <li ><a role="menuitem" tabindex="-1" href="../Role/wk_uncapped.php">WicketKeeper</a></li>
		 <li ><a role="menuitem" tabindex="-1" href="../Role/ar_uncapped.php">AllRounder</a></li>
     </ul>
	</div>
	</div>
	</div>
...
$query="SELECT * FROM `players` WHERE `Value`=0";
