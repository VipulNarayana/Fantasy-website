...
<div class="container-fluid">
	...
	<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" >Bowler
	<span class="caret"></span></button>
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          <li ><a role="menuitem" tabindex="-1" href="bowler_capped.php">Capped</a></li>
          <li ><a role="menuitem" tabindex="-1" href="bowler_uncapped.php">Uncapped</a></li>
          <li ><a role="menuitem" tabindex="-1" href="bowler_overseas.php">Overseas</a></li>
     </ul>
	</div>
	</div>
	</div>
...
$query="SELECT * FROM `players` WHERE `Role`=1";
