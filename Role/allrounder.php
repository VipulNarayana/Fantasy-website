...
<div class="container-fluid">
	...
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          ...
          <li ><a role="menuitem" tabindex="-1" href="wicketkeeper.php">WicketKeeper</a></li>
		<li  class="active"><a role="menuitem" tabindex="-1" href="allrounder.php">AllRounder</a></li>
		<li ><a role="menuitem" tabindex="-1" href="../players.php">All Players</a></li>
     </ul>
	</div>
	
	<div class="col-sm-1 col-sm-offset-1">
	<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" >AllRounder
	<span class="caret"></span></button>
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          <li ><a role="menuitem" tabindex="-1" href="ar_capped.php">Capped</a></li>
          <li ><a role="menuitem" tabindex="-1" href="ar_uncapped.php">Uncapped</a></li>
          <li ><a role="menuitem" tabindex="-1" href="ar_overseas.php">Overseas</a></li>
     </ul>
	</div>
	</div>
	</div>
...
$query="SELECT * FROM `players` WHERE `Role`=3";
				...
				else
					{
						...
						if($count1 + $count2 <= 4)
							{	
								for($i=0; $i < $N; $i++)
									{
										$query="INSERT INTO `choosen`(`Name`,`Price`,`Role`,`Value`,`Points`,`GD`) SELECT `Name`,`Price`,`Role`,`Value`,`GD_Points`,`Total_Points`` FROM `players` WHERE `Name`='$check[$i]'";
										$result=mysql_query($query);
				...
				else
					{
						...
						if($count1 + $count2 <= 4)
							{	
								for($i=0; $i < $N; $i++)
									{
										$query="INSERT INTO `ten`(`Name`,`Price`,`Role`,`Value`,`GD``Points`) SELECT `Name`,`Price`,`Role`,`Value`,GD_Points,`Total_Points` FROM `players` WHERE `Name`='$check[$i]'";
										$result=mysql_query($query);
