...
<div class="container-fluid">
	...
	<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" >Batsman
	<span class="caret"></span></button>
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          <li ><a role="menuitem" tabindex="-1" href="batsman_capped.php">Capped</a></li>
          <li ><a role="menuitem" tabindex="-1" href="batsman_uncapped.php">Uncapped</a></li>
          <li ><a role="menuitem" tabindex="-1" href="batsman_overseas.php">Overseas</a></li>
     </ul>
	</div>
	</div>
	</div>
...
$query="SELECT * FROM `players` WHERE `Role`=0";
