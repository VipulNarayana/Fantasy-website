...
<div class="container-fluid">
	...
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          <li class="active" ><a role="menuitem" tabindex="-1" href="batsman.php">Batsman</a></li>
	...
	<span class="caret"></span></button>
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          <li  class="active"><a role="menuitem" tabindex="-1" href="batsman_uncapped.php">Batsman</a></li>
		  ...
		  <li ><a role="menuitem" tabindex="-1" href="ar_uncapped.php">AllRounder</a></li>
     </ul>
	</div>
	</div>
	</div>
...
$query="SELECT * FROM `players` WHERE `Role`=0 AND `Value`=0";
