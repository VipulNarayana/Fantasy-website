...
<div class="container-fluid">
	...
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          ...
          <li class="active" ><a role="menuitem" tabindex="-1" href="bowler.php">Bowler</a></li>
	...
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          ...
          <li class="active" ><a role="menuitem" tabindex="-1" href="bowler_uncapped.php">Bowler</a></li>
...
$query="SELECT * FROM `players` WHERE `Role`=1 AND `Value`=0" ;
