...
<div class="container-fluid">
	...
	<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" >Uncapped
	<span class="caret"></span></button>
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          <li ><a role="menuitem" tabindex="-1" href="batsman_uncapped.php">Batsman</a></li>
          <li ><a role="menuitem" tabindex="-1" href="bowler_uncapped.php">Bowler</a></li>
          <li ><a role="menuitem" tabindex="-1" href="wk_uncapped.php">WicketKeeper</a></li>
		  <li class="active"><a role="menuitem" tabindex="-1" href="ar_uncapped.php">AllRounder</a></li>
     </ul>
	</div>
	</div>
	</div>
...
$query="SELECT * FROM `players` WHERE `Role`=3 AND `Value`=0";
