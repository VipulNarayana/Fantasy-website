...
<div class="container-fluid">
	...
	<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
          ...
          <li ><a role="menuitem" tabindex="-1" href="wk_overseas.php">WicketKeeper</a></li>
		  <li class="active"><a role="menuitem" tabindex="-1" href="ar_overseas.php">AllRounder</a></li>
     </ul>
	</div>
	</div>
	</div>
...
$query="SELECT * FROM `players` WHERE `Role`=3 AND `Value`=2";
